...
credhub set -n /concourse/apps/prometheus/bosh_target -t value -v director.bosh.cld.internal
credhub set -n /concourse/apps/prometheus/bosh_client -t value -v admin
credhub set -n /concourse/apps/prometheus/bosh_client_secret -t value -v <(ssh bosh-jumpbox.m.cld.gov.au bosh int bosh-bootstrap/state/creds.yml --path /admin_password)
